...
extension Reachability{
    ...
    class func ReachabilityBlock(_ hostName:String? = nil,onCompletion:@escaping(_ connection:Connection)->Void){
...
class func ReachabilityObserver(_ hostName: String? = nil,onCompletion:@escaping(_ connection:Connection)->Void) {
        ...
        //stop
    reachability?.stopNotifier()
    NotificationCenter.default.addObserver(forName: .reachabilityChanged, object: reachability, queue: OperationQueue.main, using: { (note) in
